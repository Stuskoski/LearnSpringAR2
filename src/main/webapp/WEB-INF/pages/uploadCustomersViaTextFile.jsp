...
<div class="col-lg-8 col-md-8 col-sm-6 col-xs-8">
    <form id="customerFileForm" method="POST" action="${pageContext.request.contextPath}/uploadCustomerViaFile"
        ...
        <span>
            ...
            <input class="" type="file" name="file" id="customerFile">
        </span>

        <input type="button" value="Upload" onclick="enableAnimation(); uploadCustomerFile();"
               class="customHEBButtonSmall btn">
