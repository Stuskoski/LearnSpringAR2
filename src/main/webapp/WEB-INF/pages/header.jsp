        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="${pageContext.request.contextPath}/uploadCustomers">View Customers</a></li>
                        <li><a href="${pageContext.request.contextPath}/uploadCustomers">Upload Customers</a></li>
                    </ul>
                </li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <div id="header-right-btns-div">
                    <div class="non-block">
                        <a class="btn btn-danger btn-xs non-block" href="${pageContext.request.contextPath}/signup">Sign Up</a>
                    </div>
                    <div class="non-block">
                        <a class="btn btn-danger btn-xs non-block" href="${pageContext.request.contextPath}/login">Login</a>
                    </div>
                </div>
            </ul>
        </div>
